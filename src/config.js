...
export function loadConfig() {
  const cfg = {
    ...
    resourceDbid:    getParam("resourcedbid"),
    fidResName:      getNumParam("resnamefid"),
    fidResType:      getNumParam("restypefid"),
    fidResStatus:    getNumParam("resstatusfid"),
    allocDbid:       getParam("allocdbid"),
    fidAllocProject: getNumParam("allocprojfid"),
    fidAllocTask:    getNumParam("alloctaskfid"),
    fidAllocResource:getNumParam("allocresfid"),
    fidAllocStart:   getNumParam("allocstartfid"),
    fidAllocEnd:     getNumParam("allocendfid"),
